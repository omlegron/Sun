var appControllers=angular.module('appSadminNew',[
{
  name:"bookmark",
  files:["js/services/Service.bookmark.js","js/services/Service.bookmark.js"]
}]);

appControllers.controller('SadminNewController',function(BookmarkService,TagService,Storage,focus,$scope,CONSTANT,Helpers,toaster,$state){
    $scope.bookmark={};
